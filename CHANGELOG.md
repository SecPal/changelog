...
- Visual polish pass: list item top spacing tightened to `margin.3`
...
- Visual polish pass: `WhyItMatters` callout left padding slightly increased for better presence
